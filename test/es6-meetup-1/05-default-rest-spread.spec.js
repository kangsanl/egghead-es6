...
describe('default parameters', () => {
  ...
  it('takes an object as default', () => {
    ...
    let myFunc = function ({param1='fee', param2='fie'}={}) {
  ...
  it('can take a function as default', () => {
    ...
    let myFunc = (cb=()=>'hello world!')=>{return cb()};
    let myCb = () => 'foo';
...
describe('rest parameters', () => {
  ...
  it('is a proper array vs the arguments object', () => {
    ...
    expect(args.__proto__).not.toBe(restParams.__proto__);
...
describe('spread operator', () => {
  ...
  it('can replace function.apply for argument arrays', () => {
    ...
    let funcApply = (args)=>myFunc(...args);
  ...
  it('can emulate function.apply for constructors', () => {
    ...
    let dateApply = (dateParts) => new Date(...dateParts);
